/** Aishwarya Subhlok, Prachi Mokashi, Rima Modak
 * (ID: 01641458) */
package utils;
...
public class Utils {
    ...
    public static void writeHeaderDataToCSV() {
        ...
        try {
            ...
            String[] header = {"Username", "Timestamp", "Status"};
    ...
    //  Reference URL : https://www.geeksforgeeks.org/writing-a-csv-file-in-java-using-opencsv/
    public static void appendDataToNextLineCSV(String username, String datetime, String status) {
        // first create file object for file placed at location 
        // specified by filepath 
        File file = new File(Constants.CSV_FILEPATH + "\\" + Constants.CSV_FILENAME);
        try {
            ...
            // add data to csv 
            String[] data = {username, datetime, status};
    ...
    //  Reference URL : https://www.geeksforgeeks.org/writing-a-csv-file-in-java-using-opencsv/
    public static void writeDataToNextLineCSV(String username, String datetime, String status) {
        // first create file object for file placed at location 
        // specified by filepath 
        File file = new File(Constants.CSV_FILEPATH + "\\" + Constants.CSV_FILENAME);
        try {
